...
The tables "leaf_flush.txt", "flower_budding.txt", "flowering.txt", "unripe.txt" and "ripe.txt" show the frequencies of the intensity of each phenophase thought the year. These tables are meant to create the graphs.
